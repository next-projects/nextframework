...
public class ByteValidator implements PropertyValidator {
	...
	public String getJavascriptFunctionPath() {
		return "org/nextframework/validation/validators/javascript/validateByte.js";
	}

	public String getMessage(JavascriptValidationItem validationItem) {
		return "O campo \\\""+validationItem.getFieldDisplayName()+"\\\" não é um número válido! Deve ser inteiro e estar entre -128 e 127";
	}
