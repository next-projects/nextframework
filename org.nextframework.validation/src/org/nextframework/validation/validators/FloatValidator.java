...
public class FloatValidator implements PropertyValidator {
	...
	public String getValidationName() {
		return "FloatValidations";
	}

	public String getJavascriptFunctionPath() {
		return "org/nextframework/validation/validators/javascript/validateFloat.js";
	}

	public String getMessage(JavascriptValidationItem validationItem) {
		return "O campo \\\"" + validationItem.getFieldDisplayName() + "\\\" não é um número real válido";
	}
