...
public class InscricaoEstadualValidator implements PropertyValidator {
	...
	public String getJavascriptFunctionPath() {
		return "org/nextframework/validation/validators/javascript/validateInscricaoEstadual.js";
	}

	public String getMessage(JavascriptValidationItem validationItem) {
		return "O campo \\\"" + validationItem.getFieldDisplayName() + "\\\" não é uma inscrição estadual válida";
	}
