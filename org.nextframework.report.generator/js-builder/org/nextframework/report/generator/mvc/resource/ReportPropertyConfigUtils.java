...
public class ReportPropertyConfigUtils {
	...
	public static boolean isDate(Map<String, Object> options) {
		...
		return type.equals("java.util.Calendar") || 
	...
	public static void configureFieldToAggregateInputs(final FieldDetail fieldDetail, final Input aggregateInput, final Select aggregateTypeInput) {
		...
		showElement(aggregateInput);
		showElement(aggregateTypeInput);
	...
	public static void hideElement(Node node) {
		((Element)node.parentNode.parentNode).style.display = "none";
	}

	public static void showElement(Node node) {
		((Element)node.parentNode.parentNode).style.display = "";
	}
