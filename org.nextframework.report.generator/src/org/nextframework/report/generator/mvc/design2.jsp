...
<t:tela titulo="Design de Relatórios - Passo 2 Escolher campos" useBean="model">
	...
	<div>
		...
		Tabela: ${reportTypeDisplayName} <t:property name="selectedType" type="hidden" write="false"/>
	</div>
