		...
		<n:tabPanel id="designerTab">
				...
				<div>
					<div style="float: left; width: 630px">
						...
						<div style="padding-top: 5px;">
							<button title="Permite reconfigurar os campos disponíveis para construir o relatório." onclick="ReportDesigner.getInstance().showConfigureProperties();">Configurar campos</button>
						</div>
					</div>
						...
						<div>
							<table>
								<tr style="display: none">
									<td style="width: 180px;">Legenda:</td>
									<td><input id="label" size="60" /></td>
								</tr>
								<tr style="display: none">
			...
			<n:panel title="Filtros">
				...
				<div style="float: left; width: 400px; padding-top: 20px; padding-bottom: 20px;">
					<div>
						<table>
							<tr style="display: none">
								<td><div style="width: 80px;">Legenda:</div></td>
								<td><input id="filterLabel" size="60" /></td>
							</tr>
							<tr style="display: none">
								<td>Critério fixo:</td>
								<td>
							...
							<tr style="display: none">
								<td>Valor padrão:</td>
								<td><n:input id="filterPreSelectDate" itens="${reportFilterDateAutoFilterList}" type="${ReportFilterDateAutoFilterType}" /></td>
							</tr>
							<tr style="display: none">
								<td>Valor padrão:</td>
								<td>
							...
							<tr style="display: none">
								<td colspan="2"><input type="checkbox" id="filterSelectMultiple"> <label for="filterSelectMultiple" title="Evite usar em valores que podem ter listas muito grandes">Múltiplos valores</label></td>
							</tr>
							<tr style="display: none">
								<td colspan="2"><input type="checkbox" id="filterRequired"> <label for="filterRequired">Obrigatório</label></td>
							</tr>
						</table>
					</div>
				</div>
			...
			<n:panel title="Cálculos">
				<div style="float: left; width: 380px">
					<div style="float: left">
						<n:input name="calculatedFields" id="calculatedFields" type="select-many" itens="${emptyList}" useType="java.lang.String" style="width: 200px" size="10" />
					</div>
					<div style="float: left; padding-left: 4px;">
						<button title="" onclick="ReportDesigner.getInstance().showAddCalculatedProperty();" style="width: 160px; margin-bottom: 2px;">Adicionar Cálculo</button>
						<BR />
						<button title="" onclick="ReportDesigner.getInstance().editCalculatedProperty();" style="width: 160px; margin-bottom: 2px;">Editar Cálculo</button>
						<BR />
						<button title="" onclick="ReportDesigner.getInstance().removeSelectedCalculatedProperty();" style="width: 160px; margin-bottom: 2px;">Remover Cálculo</button>
					</div>
				</div>
			</n:panel>
			<%--
...
<div id="calculatedPropertiesWizzard" class="propertiesWizzard" style="display: none;">
	<div style="position: absolute; left: 0px; top: 0px; width: 100%; height: 100%; background-color: white" class="blockview">&nbsp;</div>
				...
				<div style="height: 500px; overflow: auto; font-weight: normal">
					...
					<div id="c_customized">
						...
						<div style="margin-top: 4px; margin-bottom: 12px;">
							...
							<div style="margin: 6px;">
								<label> <input type="radio" name="calculationFormatAs" id="calculationFormatAsTime" value="time" /> Tempo &nbsp;&nbsp;
						...
						<div style="margin-top: 4px; margin-bottom: 12px;">
							<div style="margin-bottom: 6px;">Processadores</div>
							<n:input name="calculationProcessor" type="select-many" itens="${reportCalculatedFieldsProcessor}" />
						</div>
						<div style="margin-top: 4px; margin-bottom: 12px;">
							<div id="validationExpressionError" style="color: red; min-height: 26px;"></div>
						</div>
						<div>
	...
	<div class="chartBox">
		<div class="chartBody">
			...
			<div id="chartWizzard_page_1">
				...
				<div>
					<div>
						<input type="radio" style="border: 0px;" name="chartType" value="pie" id="chartTypePie" checked="checked" /> <label for="chartTypePie"> <img src="${app}/resource/org/nextframework/report/generator/mvc/resource/pieChart.png" style="width: 64px; height: 64px;" align="middle"> Pizza
						</label>
					</div>
					<div id="typeColumn">
						<input type="radio" style="border: 0px;" name="chartType" value="column" id="chartTypeColumn" /> <label for="chartTypeColumn"> <img src="${app}/resource/org/nextframework/report/generator/mvc/resource/columnChart.png" style="width: 64px; height: 64px;" align="middle"> Colunas
						</label>
					</div>
					<div id="typeLine">
						<input type="radio" style="border: 0px;" name="chartType" value="line" id="chartTypeLine" /> <label for="chartTypeLine"> <img src="${app}/resource/org/nextframework/report/generator/mvc/resource/lineChart.png" style="width: 64px; height: 64px;" align="middle"> Linhas
						</label>
					</div>
					<%--
					<div id="typeBar">
			...
			<div id="chartWizzard_page_2" style="display: none">
				...
				<div class="chartPageSection" id="chartSeriesSectionType">
					...
					<div>
						<div class="spacer">
							<div>
								<input type="radio" style="border: 0px" name="seriesType" value="propertiesDefault" id="propertyTypeDefault" checked="checked" /> <label for="propertyTypeDefault"> Usar uma propriedade como série e outra como valor. </label>
							</div>
							<div>
								<input type="radio" style="border: 0px" name="seriesType" value="propertiesAsSeries" id="propertyTypeAsSeries" /> <label for="propertyTypeAsSeries"> Usar propriedades como série e valor. </label>
							</div>
						</div>
					</div>
				</div>
				<div id="propertiesDefaultBlock">
					...
					<div class="chartPageSection">
						...
						<div>
							...
							<div class="spacer">
								<div>
									<input type="radio" style="border: 0px" checked="checked" name="pieCount" value="true" id="chartCountTrue" /> <label for="chartCountTrue"> Mostrar número de itens como valor. </label>
								</div>
								<div>
									<input type="radio" style="border: 0px;" name="pieCount" value="false" id="chartCountFalse"> <label for="chartCountFalse"> Valor: </label>
				...
				<div class="chartPageSection">
					...
					<table>
						<tr>
							...
							<td><input type="text" id="chartTitle" size="27" /></td>
						</tr>
						<tr>
							<td>Rótulo dos grupos (eixo horizontal):</td>
							<td><input type="text" id="chartGroupTitle" size="27" /></td>
						</tr>
						<tr>
							<td>Rótulo das series (eixo vertical):</td>
							<td><input type="text" id="chartSeriesTitle" size="27" /></td>
						</tr>
					</table>
				</div>
				<div class="chartPageSection">
