...
//		layoutMethod.statement("super.layoutReport()");
...
//		groupProperty = checkDescriptor(groupProperty);
	...
	private String getPatternForGroupLevel(String groupLevel) {
		switch (Integer.parseInt(groupLevel)) {
			case Calendar.YEAR: return "yyyy";
			case Calendar.MONTH: return "MM/yyyy";
			case Calendar.DATE: return "dd/MM/yyyy";
			case Calendar.HOUR_OF_DAY: return "dd/MM/yyyy HH";
