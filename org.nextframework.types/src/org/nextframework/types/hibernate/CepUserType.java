...
public class CepUserType implements UserType<Cep> {
	...
	@Override
	public Cep nullSafeGet(ResultSet rs, int position, SharedSessionContractImplementor session, Object owner) throws SQLException {
	...
	@Override
	public void nullSafeSet(PreparedStatement st, Cep value, int index, SharedSessionContractImplementor session) throws SQLException {
		if (value != null) {
