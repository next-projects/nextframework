...
public class CpfUserType implements UserType<Cpf> {
	...
	@Override
	public Cpf nullSafeGet(ResultSet rs, int position, SharedSessionContractImplementor session, Object owner) throws SQLException {
	...
	@Override
	public void nullSafeSet(PreparedStatement st, Cpf value, int index, SharedSessionContractImplementor session) throws SQLException {
		if (value != null) {
