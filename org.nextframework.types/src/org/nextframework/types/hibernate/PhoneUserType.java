...
public class PhoneUserType implements UserType<Phone> {
	...
	@Override
	public Phone nullSafeGet(ResultSet rs, int position, SharedSessionContractImplementor session, Object owner) throws SQLException {
	...
	@Override
	public void nullSafeSet(PreparedStatement st, Phone value, int index, SharedSessionContractImplementor session) throws SQLException {
		if (value != null) {
