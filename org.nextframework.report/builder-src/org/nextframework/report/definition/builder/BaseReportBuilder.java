...
//				chart.getStyle().setValuesFormatter();
	...
	protected ReportChart chartPropertiesAsSeries(ChartType chartType, int w, int h, String chartTitle, String groupProperty, String... seriesProperties) {
	...
	protected ReportChart chartPropertiesAsSeries(ChartType chartType, String chartTitle, List<?> chartData, String groupProperty, String... seriesProperties) {
		return chartPropertiesAsSeries(chartType, 0, 0, chartTitle, chartData, groupProperty, seriesProperties);
	}
	protected ReportChart chartPropertiesAsSeries(ChartType chartType, int w, int h, String chartTitle, List<?> chartData, String groupProperty, String... seriesProperties) {
		Chart chart = createChart(chartType, chartTitle);
		if(w != 0 && h != 0){
