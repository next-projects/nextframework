...
public abstract class AbstractJFreeTypeRenderer implements JFreeTypeRenderer {
	...
	protected String getLabelString(Chart chart, Object label) {
		PropertyEditor formatter = chart.getLabelsFormatter();
		if (formatter != null) {
	...
	protected Comparable<String> getGroupString(Chart chart, Object group) {
		PropertyEditor formatter = chart.getGroupFormatter();
		if (formatter != null) {
	...
	protected String getSerieString(Chart chart, Comparable<?> serie) {
		PropertyEditor formatter = chart.getSeriesFormatter();
		if (formatter != null) {
	...
	protected void configureCategoryPlotDetails(Plot plot, Chart chart) {
		...
		if (plot instanceof CategoryPlot) {
			...
			categoryPlot.getDomainAxis().setLabel(getLabelString(chart, chart.getData().getGroupTitle()));
			categoryPlot.getRangeAxis().setLabel(getLabelString(chart, chart.getData().getSeriesTitle()));
