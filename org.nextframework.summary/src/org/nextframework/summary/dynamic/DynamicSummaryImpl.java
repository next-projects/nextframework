...
//		Class<? extends Summary> summaryClass = DynamicSummary.getInstance(DynamicGroup.class)
//			.addGroup("name")
//			.getSummaryClass();
//		ArrayList rows = new ArrayList();
//		rows.add(new DynamicGroup("A"));
//		rows.add(new DynamicGroup("A"));
//		rows.add(new DynamicGroup("B"));
//		rows.add(new DynamicGroup("B"));
//		SummaryResult createFrom = SummaryResult.createFrom(rows, summaryClass);
//		
//		TextReportPrinter.print(createFrom.getItems());
//		//System.out.println(((ParameterizedType)X.class.getGenericSuperclass()).getActualTypeArguments()[0]);
//	}
}
