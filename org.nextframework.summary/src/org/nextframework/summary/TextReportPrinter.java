...
public class TextReportPrinter {
	...
	<ROW, SUMARY extends Summary<ROW>> 
	void printRowForGroup(SummaryRow<ROW, SUMARY> row, String group){
	...
	<ROW, SUMARY extends Summary<ROW>> 
	void printFirstRow(SummaryRow<ROW, SUMARY> row) {
	...
	<ROW, SUMARY extends Summary<ROW>>
	void printValue(SummaryRow<ROW, SUMARY> row, SummaryItemDefinition summaryItemDefinition, String padding) {
		out.print(padding);
	...
	<ROW, SUMARY extends Summary<ROW>> 
	List<SummaryItemDefinition> filterItens(SummaryRow<ROW, SUMARY> row, Class<? extends SummaryItemDefinition> classe, Scope scope) {
