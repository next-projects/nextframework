...
<select name="${tag.name}" id="${tag.id}" ${n:attributeNotEmpty('onchange', tag.reloadOnChangeString)} ${tag.dynamicAttributesToString}>${tag.selectoneblankoption}${tag.inputComponent.selectItensString}</select>
</td>
