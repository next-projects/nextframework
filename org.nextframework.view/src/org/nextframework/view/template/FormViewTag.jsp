...
<t:view title="${formViewTag.title}" useBean="${crudContext.beanName}" propertyMode="${param.ACTION=='view' ? 'output' : 'input'}" formEnctype="${formViewTag.dynamicAttributesMap['formEnctype']}">
