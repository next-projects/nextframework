...
<n:dataGrid itens="${listTableTag.itens}" var="${listTableTag.name}" cellspacing="0" groupProperty="${listTableTag.groupProperty}" nocolumnresize="${listTableTag.dynamicAttributesMap['nocolumnresize']}">
