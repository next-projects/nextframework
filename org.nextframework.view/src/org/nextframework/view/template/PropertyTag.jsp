	...
	<c:choose>
		...
		<c:when test="${propertyTag.renderAs == 'double'}">
			<n:panel id="lp_${compId}" class="${propertyTag.labelPanelStyleClass}" style="${propertyTag.labelPanelStyle}">
				<label id="l_${compId}" for="${compId}" class="${propertyTag.labelStyleClass}" style="${propertyTag.labelStyle}"><n:output trueFalseNullLabels="${propertyTag.trueFalseNullLabels}" value="${n:default(label, propertyTag.label)}" /></label>
			</n:panel>
		...
		<c:when test="${propertyTag.renderAs == 'stacked'}">
			<n:panel id="p_${compId}" class="${propertyTag.panelStyleClass}" style="${propertyTag.panelStyle}" colspan="${propertyTag.colspan}">
				<label id="l_${compId}" for="${compId}" class="${propertyTag.labelStyleClass}" style="${propertyTag.labelStyle}"><n:output trueFalseNullLabels="${propertyTag.trueFalseNullLabels}" value="${n:default(label, propertyTag.label)}" /></label>
				<div id="s_${compId}" class="${propertyTag.stackedPanelStyleClass}">
					<c:if test="${propertyTag.mode == 'input'}">
