//	Alteraçoes por Glauco
//	remoçao dos botoes insert_table , about, popupeditor, help
...
this.imgURL = _editor_url; //diretorio das imagens
this.debug  = 0;
...
//  ['custom1','custom2','custom3','separator'],'InsertTable'
//  ['popupeditor','about']];
...
function editor_action(button_id) {
  ...
  // help popup
  if (cmdID == 'showhelp') {
    window.open(_editor_url + "/editor_help.html", 'EditorHelp'); // popups
    return;
  }
