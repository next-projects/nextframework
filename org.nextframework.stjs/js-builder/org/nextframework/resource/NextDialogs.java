...
public class NextDialogs {
	...
	private static abstract class AbstractDialog<E extends AbstractDialog<?>> {
		...
		public AbstractDialog() {
			...
			body.className = next.globalMap.get("NextDialogs.body", "popup_box_body");
	...
	public static class MessageDialog extends AbstractDialog<MessageDialog> {
		...
		public void show() {
			...
			Element titleDiv = next.dom.newElement("div", $map("innerHTML", title, "class", next.globalMap.get("NextDialogs.header", "separator")));
	...
	public InputNumberMessageDialog showInputNumberDialog(String title, String mensagem) {
		...
		Div messageDiv = next.dom.newElement("div", JSCollections.$map("innerHTML", mensagem));
