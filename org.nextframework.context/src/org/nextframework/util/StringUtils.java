...
public class StringUtils {
	...
	public String toStringIdStyled(Object o, boolean includeDescription) {
		...
		if (idProperty == null) {
			//CODIGO INSERIDO EM 16 DE NOVEMBRO DE 2006 PARA O AJAX SUPORTAR LISTAS QUE NAO SÃO DE BEANS (EX LISTA DE INTEIROS)		
	...
	public String removeAccents(String string) {
		...
		String str = string;
		String searchChars = "ÁÉÍÓÚÀÈÌÒÙÂÊÎÔÛÄËÏÖÜÃÕÇáéíóúàèìòùâêîôûäëïöüãõç";
